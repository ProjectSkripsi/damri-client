                ...
                <div class="col-md-12">
                    <card>
                        <div id="pdf">
                            <header class="clearfix">
                                <div class="row">
                                    <div class="col-sm-2 mt-md">
                                        <div class="ib">
                                            <img src="/img/litha.png" height="40px" width='180px' alt="Damri" />
                                        </div>
                                    </div>
                                    <div class="col-sm-8 mt-md text-center">
                                        <h5>Pemeriksaan/Inspeksi Kendaraan Bermotor</h5>
                                        <p class="vechile"><i>Vechile Inspection</i></p>                            
                                    </div>
                                    <div class="col-sm-2 mt-md">
                                        <div class="text-right">
                                            <img src="/img/K3.png" height="70px" alt="K3" />
                                        </div>
                                    </div>
                                </div>
                            </header><hr>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-5">
                                    7. Head Light or High Beam / Lampu Besar Jauh
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-5">
                                    8. Head Light or Low Beam / Lampu Besar Dekat
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-5">
                                    9. Front Flaser Light / Lampu Tanda Belok Depan
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-5">
                                    10. Rear Flaser Light / Lampu Tanda Belok Belakang
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-5">
                                    11. Brake or Stop Light / Lampu Rem
                                </div>
                                <div class="col-md-1">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <button class="btn btn-success btn-sm" @click.prevent="print" ><i class="fa fa-floppy-o" aria-hidden="true"></i> Cetak</button>
                        </div>
                    </div>
                </div>
            </div>
